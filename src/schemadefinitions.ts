...
export const displayAttributes: Attribute[] =   [
  ...
  { id : "energielabels",
    ...
    { id : "epl-pand-SBIcode",
      name : "SBI Code",
      type : "string",
      vocabulary : [  [  { id: "C", label: "C Industrie" } ,   { id: "18", label: "18 Drukkerijen, reproductie van opgenomen media" } ,   { id: "20", label: "20 Vervaardiging van chemische producten" } ,   { id: "25", label: "25 Vervaardiging van producten van metaal (geen machines en apparaten)" } ,   { id: "31", label: "31 Vervaardiging van meubels" } ,  ] ,   [  { id: "D", label: "Productie en distributie van en handel in elektriciteit, aardgas, stoom en gekoelde lucht" } ,   { id: "35", label: "Productie en distributie van en handel in elektriciteit, aardgas, stoom en gekoelde lucht" } ,  ] ,   [  { id: "E", label: "E Winning en distributie van water; afval- en afvalwaterbeheer en sanering" } ,   { id: "38", label: "38 Afvalinzameling en -behandeling; voorbereiding tot recycling" } ,  ] ,   [  { id: "F", label: "F Bouwnijverheid" } ,   { id: "41", label: "41 Algemene burgerlijke en utiliteitsbouw en projectontwikkeling" } ,   [  { id: "42", label: "42 Grond-, water- en wegenbouw (geen grondverzet)" } ,   { id: "42.1", label: "42.1 Bouw van wegen, spoorwegen en kunstwerken" } ,  ] ,   [  { id: "43", label: "43 Gespecialiseerde werkzaamheden in de bouw" } ,   { id: "43.9", label: "43.9 Dakbouw en overige gespecialiseerde werkzaamheden in de bouw" } ,  ] ,  ] ,   [  { id: "G", label: "G Groot- en detailhandel; reparatie van auto\'s" } ,   [  { id: "45", label: "45 Handel in en reparatie van auto\'s, motorfietsen en aanhangers" } ,   [  { id: "45.2", label: "45.2 Gespecialiseerde reparatie van auto\'s" } ,   [  { id: "45.20", label: "45.20 Gespecialiseerde reparatie van auto\'s" } ,   { id: "45.20.3", label: "45.20.3 Reparatie van specifieke auto-onderdelen" } ,  ] ,  ] ,   [  { id: "45.3", label: "45.3 Handel in auto-onderdelen en -accessoires" } ,   [  { id: "45.31", label: "Groothandel en handelsbemiddeling in auto-onderdelen en -accessoires" } ,   { id: "45.31.1", label: "Groothandel en handelsbemiddeling in auto-onderdelen en -accessoires (geen banden)" } ,  ] ,  ] ,  ] ,   { id: "46", label: "46 Groothandel en handelsbemiddeling (niet in auto\'s en motorfietsen)" } ,   [  { id: "47", label: "47 Detailhandel (niet in auto\'s)" } ,   [  { id: "47.1", label: "Supermarkten, warenhuizen en dergelijke winkels met een algemeen assortiment" } ,   { id: "47.11", label: "Supermarkten en dergelijke winkels met een algemeen assortiment voedings- en genotmiddelen" } ,  ] ,   [  { id: "47.9", label: "47.9 Detailhandel niet via winkel of markt" } ,   { id: "47.91", label: "47.91 Detailhandel via internet" } ,   [  { id: "47.99", label: "Colportage, straathandel en detailhandel via overige distributievormen" } ,   { id: "47.99.9", label: "47.99.9 Detailhandel via overige distributievormen" } ,  ] ,  ] ,  ] ,  ] ,   [  { id: "H", label: "H Vervoer en opslag" } ,   { id: "49", label: "49 Vervoer over land" } ,   { id: "52", label: "52 Opslag en dienstverlening voor vervoer" } ,   [  { id: "53", label: "53 Post en koeriers" } ,   [  { id: "53.2", label: "53.2 Post zonder universele dienstverplichting en koeriers" } ,   [  { id: "53.20", label: "53.20 Post zonder universele dienstverplichting en koeriers" } ,   { id: "53.20.1", label: "53.20.1 Post zonder universele dienstverplichting" } ,  ] ,  ] ,  ] ,  ] ,   [  { id: "I", label: "I Logies-, maaltijd- en drankverstrekking" } ,   [  { id: "55", label: "55 Logiesverstrekking" } ,   [  { id: "55.1", label: "55.1 Hotels e.d." } ,   [  { id: "55.10", label: "55.10 Hotels e.d." } ,   { id: "55.10.1", label: "55.10.1 Hotel-restaurants" } ,  ] ,  ] ,  ] ,   [  { id: "56", label: "56 Eet- en drinkgelegenheden" } ,   [  { id: "56.1", label: "56.1 Restaurants, cafetaria\'s e.d." } ,   [  { id: "56.10", label: "56.10 Restaurants, cafetaria\'s e.d. en ijssalons" } ,   { id: "56.10.2", label: "56.10.2 Fastfoodrestaurants, cafetaria\'s,  ijssalons, eetkramen e.d." } ,  ] ,  ] ,   [  { id: "56.3", label: "56.3 Cafés" } ,   { id: "56.30", label: "56.30 Cafés" } ,  ] ,  ] ,  ] ,   [  { id: "J", label: "J Informatie en communicatie" } ,   { id: "58", label: "58 Uitgeverijen" } ,   { id: "59", label: "Productie en distributie van films en televisieprogramma´s; maken en uitgeven van geluidsopnamen" } ,   { id: "61", label: "61 Telecommunicatie" } ,   { id: "62", label: "62 Dienstverlenende activiteiten op het gebied van informatietechnologie" } ,   { id: "63", label: "63 Dienstverlenende activiteiten op het gebied van informatie" } ,  ] ,   [  { id: "K", label: "K Financiële instellingen" } ,   [  { id: "64", label: "64 Financiële instellingen (geen verzekeringen en pensioenfondsen)" } ,   { id: "64.3", label: "64.3 Beleggingsinstellingen" } ,  ] ,   { id: "65", label: "65 Verzekeringen en pensioenfondsen (geen verplichte sociale verzekeringen)" } ,   { id: "66", label: "66 Overige financiële dienstverlening" } ,  ] ,   [  { id: "L", label: "L Verhuur van en handel in onroerend goed" } ,   [  { id: "68", label: "68 Verhuur van en handel in onroerend goed" } ,   [  { id: "68.2", label: "68.2 Verhuur van onroerend goed" } ,   [  { id: "68.20", label: "68.20 Verhuur van onroerend goed" } ,   { id: "68.20.1", label: "68.20.1 Woningbouwverenigingen en -stichtingen" } ,  ] ,  ] ,  ] ,  ] ,   [  { id: "M", label: "M Advisering, onderzoek en overige specialistische zakelijke dienstverlening" } ,   { id: "69", label: "Rechtskundige dienstverlening, accountancy, belastingadvisering en administratie" } ,   { id: "70", label: "Holdings (geen financiële), concerndiensten binnen eigen concern en managementadvisering" } ,   { id: "71", label: "Architecten, ingenieurs en technisch ontwerp en advies; keuring en controle" } ,   { id: "72", label: "72 Speur- en ontwikkelingswerk" } ,   { id: "73", label: "73 Reclame en marktonderzoek" } ,   { id: "74", label: "Industrieel ontwerp en vormgeving, fotografie, vertaling en overige consultancy" } ,   { id: "75", label: "75 Veterinaire dienstverlening" } ,  ] ,   [  { id: "N", label: "N Verhuur van roerende goederen en overige zakelijke dienstverlening" } ,   { id: "77", label: "Verhuur en lease van auto\'s, consumentenartikelen, machines en overige roerende goederen" } ,   { id: "78", label: "78 Arbeidsbemiddeling, uitzendbureaus en personeelsbeheer" } ,   { id: "79", label: "Reisbemiddeling, reisorganisatie, toeristische informatie en reserveringsbureaus" } ,   { id: "81", label: "81 Facility management, reiniging en landschapsverzorging" } ,   [  { id: "82", label: "82 Overige zakelijke dienstverlening" } ,   [  { id: "82.9", label: "82.9 Overige zakelijke dienstverlening(rest)" } ,   [  { id: "82.99", label: "82.99 Overige zakelijke dienstverlening (rest)" } ,   { id: "82.99.9", label: "82.99.9 Overige zakelijke dienstverlening (rest)" } ,  ] ,  ] ,  ] ,  ] ,   [  { id: "O", label: "O Openbaar bestuur, overheidsdiensten en verplichte sociale verzekeringen" } ,   { id: "84", label: "84 Openbaar bestuur, overheidsdiensten en verplichte sociale verzekeringen" } ,  ] ,   [  { id: "P", label: "P Onderwijs" } ,   [  { id: "85", label: "85 Onderwijs" } ,   [  { id: "85.2", label: "85.2 Primair en speciaal onderwijs" } ,   [  { id: "85.20", label: "85.20 Primair en speciaal onderwijs" } ,   { id: "85.20.1", label: "85.20.1 Basisonderwijs voor leerplichtigen" } ,  ] ,  ] ,  ] ,  ] ,   [  { id: "Q", label: "Q Gezondheids- en welzijnszorg" } ,   [  { id: "86", label: "86 Gezondheidszorg" } ,   [  { id: "86.1", label: "Ziekenhuizen en geestelijke gezondheids- en verslavingszorg met overnachting" } ,   [  { id: "86.10", label: "Ziekenhuizen en geestelijke gezondheids- en verslavingszorg met overnachting" } ,   { id: "86.10.3", label: "86.10.3 Categorale ziekenhuizen" } ,  ] ,  ] ,   [  { id: "86.2", label: "86.2 Medische en tandheelkundige praktijken" } ,   { id: "86.21", label: "86.21 Praktijken van huisartsen" } ,  ] ,   [  { id: "86.9", label: "86.9 Paramedische praktijken en overige gezondheidszorg zonder overnachting" } ,   [  { id: "86.92", label: "Overige aanbieders van gezondheidszorg zonder overnachting en gezondheidsondersteunende diensten" } ,   { id: "86.92.4", label: "Medische laboratoria, trombosediensten en overig behandelingsondersteunend onderzoek" } ,  ] ,  ] ,  ] ,   { id: "87", label: "87 Verpleging, verzorging en begeleiding met overnachting" } ,   [  { id: "88", label: "88 Maatschappelijke dienstverlening zonder overnachting" } ,   [  { id: "88.9", label: "Maatschappelijke dienstverlening zonder overnachting niet specifiek gericht op ouderen en gehandicapten" } ,   [  { id: "88.91", label: "88.91 Kinderopvang en peuterspeelzaalwerk" } ,   { id: "88.91.1", label: "88.91.1 Kinderopvang" } ,  ] ,  ] ,  ] ,  ] ,   [  { id: "R", label: "R Cultuur, sport en recreatie" } ,   { id: "90", label: "90 Kunst" } ,   [  { id: "91", label: "Culturele uitleencentra, openbare archieven, musea, dieren- en plantentuinen, natuurbehoud" } ,   [  { id: "91.0", label: "Culturele uitleencentra, openbare archieven, musea, dieren- en plantentuinen, natuurbehoud" } ,   [  { id: "91.02", label: "91.02 Musea, kunstgalerieën en –expositieruimten" } ,   { id: "91.02.1", label: "91.02.1 Musea" } ,  ] ,  ] ,  ] ,   { id: "92", label: "92 Loterijen en kansspelen" } ,   [  { id: "93", label: "93 Sport en recreatie" } ,   [  { id: "93.1", label: "93.1 Sport" } ,   [  { id: "93.12", label: "93.12 Buitensport" } ,   { id: "93.12.1", label: "93.12.1 Veldvoetbal" } ,  ] ,   { id: "93.13", label: "93.13 Fitnesscentra" } ,  ] ,  ] ,  ] ,   [  { id: "S", label: "S Overige dienstverlening" } ,   { id: "94", label: "Levensbeschouwelijke en politieke organisaties, belangen- en ideële organisaties, hobbyclubs" } ,   { id: "95", label: "95 Reparatie van computers en consumentenartikelen" } ,   { id: "96", label: "96 Wellness en overige dienstverlening; uitvaartbranche" } ,  ] ,  ]
    },
