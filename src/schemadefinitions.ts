...
export const displayAttributes: Attribute[] = [
  { id: "naam", name: "Adres", type: "string" },

  { id: "id", name: "Identificatie", type: "string" },

  { id: "bag-object-type", name: "Object type", type: "string" },

  { id: "bag-aob-gebruiksdoel", name: "Gebruiksdoel", type: "string" },
  ...
  { id: "bag-aob-status", name: "BAG status", type: "string" },

  {
    id: "links",
    name: "Externe referenties",
    attributes: [
      { id: "href-luchtfoto", name: "Luchtfoto", type: "URL" },

      { id: "href-streetview", name: "Google Streetview", type: "URL" },

      { id: "href-topotijdreis", name: "Topo tijdreis", type: "URL" },

      { id: "href-utrechtsarchief", name: "Utrechts archief", type: "URL" },
...

  {
    ...
    attributes: [
      ...
      { id: "bag-opr-naam", name: "Openbare ruimte", type: "string" },
    ],
  },

  {
    ...
    attributes: [
      ...
      { id: "bag-pnd-status", name: "Status", type: "string" },
    ],
  },

  {
    ...
    attributes: [
      { id: "btk-kenmerk-id", name: "Bouwtechnisch kenmerk", type: "string" },

      { id: "btk-inspectiedatum", name: "Inspectiedatum", type: "string" },
...

  {
    ...
    name: "Wijk/buurt",
    attributes: [
      { id: "bwk-wijknaam", name: "Wijknaam", type: "string" },

      { id: "bwk-subwijknaam", name: "Subwijk", type: "string" },

      { id: "bwk-buurtnaam", name: "Buurt", type: "string" },

      { id: "bwk-subbuurtnaam", name: "Subbuurt", type: "string" },
    ],
  },

  {
    ...
    name: "Adres",
    attributes: [
      { id: "bag-num-volledig", name: "Hoofdadres", type: "string" },

      { id: "bag-num-postcode", name: "Postcode", type: "string" },

      { id: "bag-num-huisnummer", name: "Huisnummer", type: "string" },

      { id: "bag-num-huisletter", name: "Huisletter", type: "string" },
      ...
      { id: "bag-num-status", name: "BAG status", type: "string" },

      { id: "bag-opr-naam", name: "Openbare ruimte", type: "string" },

      { id: "bag-wpl-naam", name: "Woonplaats", type: "string" },
    ],
  },

  {
    ...
    name: "Nevenadres",
    attributes: [
      { id: "bag-num-volledig-neven", name: "Nevenadres", type: "string" },

      { id: "bag-num-postcode-neven", name: "Postcode", type: "string" },

      { id: "bag-num-huisnummer-neven", name: "Huisnummer", type: "string" },

      { id: "bag-num-huisletter-neven", name: "Huisletter", type: "string" },
      ...
      { id: "bag-opr-naam-neven", name: "Openbare ruimte", type: "string" },

      { id: "bag-wpl-naam-neven", name: "Woonplaats", type: "string" },
    ],
  },

  {
    ...
    attributes: [
      { id: "titel", name: "Titel", type: "string" },

      { id: "ob-documenttype", name: "Documenttype", type: "string" },

      { id: "wijzigingsdatum", name: "Wijzigingsdatum", type: "string" },

      { id: "publicatiedatum", name: "Publicatiedatum", type: "string" },

      { id: "ob-onderwerp", name: "Onderwerp", type: "string" },

      { id: "url-vindplaats", name: "Vindplaats", type: "URL" },
    ],
  },

  {
    ...
    attributes: [
      { id: "zk-nummer", name: "Zaaknummer", type: "string" },

      { id: "omschrijving", name: "Omschrijving", type: "string" },

      { id: "zk-soort", name: "Zaaksoort", type: "string" },

      { id: "zk-fase", name: "Fase", type: "string" },

      { id: "zk-status", name: "Voortgangsstatus", type: "string" },

      { id: "zk-besluit", name: "Besluit", type: "string" },

      { id: "date", name: "Datum", type: "string" },

      { id: "besluitdatum", name: "Besluitdatum", type: "string" },

      { id: "zk-startdatum", name: "Startdatum", type: "string" },
      ...
      { id: "zk-einddatum", name: "Einddatum", type: "string" },
...
export const filterAttributes: Attribute[] = [
...

  {
    ...
    attributes: [
      ...
      { id: "bag-pnd.bag-pnd-status", name: "Status", type: "string" },
    ],
  },
...

  {
    ...
    name: "Pand Vergunningen",
    attributes: [
      { id: "pand-vergunningen.zk-soort", name: "Zaaksoort", type: "string" },

      { id: "pand-vergunningen.zk-fase", name: "Fase", type: "string" },
...
export interface GBPObject {
  ...
  links: {
    "href-luchtfoto": string;
    "href-streetview": string;
    "href-topotijdreis": string;
    "href-utrechtsarchief": string;
    "href-ruimtelijkeplannen": string;
  };
  "bag-opr": {
    naam: string;
    id: string;
  ...
  "bag-pnd": {
    ...
    "bag-pnd-oorspronkelijk-bouwjaar-interval": string;
    "bag-pnd-status": string;
    "bag-pnd-geconstateerd": string;
    "bag-pnd-documentdatum": Date;
    "bag-pnd-documentnummer": string;
    "bag-pnd-geo": number[];
    "bag-pnd-geo-EPSG28992": number[];
  };
  "bouwtechnische-kenmerken": {
    "btk-kenmerk-id": string[];
    "btk-inspectiedatum": Date;
    "btk-actie-nodig": Date;
  };
  bwk: {
    "bwk-wijkid": string;
    "bwk-wijknaam": string;
    "bwk-subwijknaam": string;
    "bwk-buurtid": string;
    "bwk-buurtnaam": string;
    "bwk-subbuurtnaam": string;
  };
  hoofdadres: {
    "bag-num-id": string;
  ...
  nevenadres: {
    ...
    "bag-num-huisnummer-neven": number;
    "bag-num-huisletter-neven": string;
    "bag-num-huisnummertoevoeging-neven": string;
    "bag-num-huisnummer-letter-aanduiding-neven": string;
    "bag-opr-id-neven": string;
    "bag-opr-naam-neven": string;
    "bag-opr-type-neven": string;
    "bag-wpl-id-neven": string;
    "bag-wpl-naam-neven": string;
  };
  "officiele-bekendmakingen": {
    identificatie: string;
    titel: string;
    "ob-documenttype": string[];
    wijzigingsdatum: Date;
    publicatiedatum: Date;
    "ob-onderwerp": string[];
    "url-vindplaats": string;
  };
  "pand-vergunningen": {
    "zk-nummer": string;
    omschrijving: string;
    ...
    besluitdatum: Date;
    "zk-startdatum": Date;
    "zk-startdatum-gepland": Date;
    "zk-einddatum": Date;
    "zk-einddatum-gepland": Date;
  };
}
